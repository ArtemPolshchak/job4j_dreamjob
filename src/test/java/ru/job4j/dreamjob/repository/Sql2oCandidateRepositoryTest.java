...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var vacancy = sql2oCandidateRepository.save(new Candidate(0, "name", "description", creationDate, true, 1, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy1 = sql2oCandidateRepository.save(new Candidate(0, "name1", "description1", creationDate, true, 1, file.getId()));
        var vacancy2 = sql2oCandidateRepository.save(new Candidate(0, "name2", "description2", creationDate, false, 1, file.getId()));
        var vacancy3 = sql2oCandidateRepository.save(new Candidate(0, "name3", "description3", creationDate, true, 1, file.getId()));
